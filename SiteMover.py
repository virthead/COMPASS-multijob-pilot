...
#            _cmd_str = _cmd_str.replace('XXX', '')
    ...
    def put_data(self, source, destination, fsize=0, fchecksum=0, **pdict):
        ...
        ec, pilotErrorDiag, tracer_error, dst_loc_pfn, lfcdir, surl = si.getProperPaths(error, analyJob, token, prodSourceLabel, dsname, filename, scope=scope, jobId=jobId, sitemover=self) # quick workaround
        if ec != 0:
